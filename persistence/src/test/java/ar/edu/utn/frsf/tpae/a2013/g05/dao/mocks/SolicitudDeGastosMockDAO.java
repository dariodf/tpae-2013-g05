...
public class SolicitudDeGastosMockDAO implements SolicitudDeGastosDAO {
	...
	boolean dbCaida = true;
	@Override
	public SolicitudDeGastos persistir(SolicitudDeGastos solicitudDeGastos) {
		if(dbCaida)
			return null;
		SolicitudDeGastos solicitud = new SolicitudDeGastos(1, new CentroDeCosto(1, "Centro Uno"), "Gastos en viajes a CBA", 12354, "No Procesada", new Supervisor(3, "Dario", "5678", "De Filippis",
		...
		if(idEmpleado == 1){
			...
			solicitudes.add(new SolicitudDeGastos(1, new CentroDeCosto(1, "Centro Uno"), "Gastos en viajes a CBA", 12354, "No Procesada", new Supervisor(3, "Dario", "5678", "De Filippis",
					"Dario", "30789456", new Date()),new Empleado(1, "Agustin","1234", "Martinez",
							"Agustin", "32123456", "Programador Java Junior", "20321234568",
							"123456789012345678901234567890", "156123456", "mrtnz.agustin@gmail.com")));
			solicitudes.add(new SolicitudDeGastos(2, new CentroDeCosto(2, "Centro Dos"), "Gastos en viajes a ER", 12354, "No Procesada", new Supervisor(3, "Dario", "5678", "De Filippis",
					"Dario", "30789456", new Date()),new Empleado(1, "Agustin","1234", "Martinez",
							"Agustin", "32123456", "Programador Java Junior", "20321234568",
							"123456789012345678901234567890", "156123456", "mrtnz.agustin@gmail.com")));
			solicitudes.add(new SolicitudDeGastos(3, new CentroDeCosto(2, "Centro Dos"), "Comidas evento Federal", 12354, "No Procesada", new Supervisor(3, "Dario", "5678", "De Filippis",
					"Dario", "30789456", new Date()),new Empleado(1, "Agustin","1234", "Martinez",
							"Agustin", "32123456", "Programador Java Junior", "20321234568",
							"123456789012345678901234567890", "156123456", "mrtnz.agustin@gmail.com")));	
			return solicitudes;
