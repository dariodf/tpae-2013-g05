...
public class GastoMockDAO implements GastoDAO{
	...
	public List<Gasto> listarGastos(List<CentroDeCosto> centrosDeCosto,
		...
		Gasto gastoCuatro = new Gasto(3, new SolicitudDeGastos(5, new CentroDeCosto(1, "Centro Uno"), "Gastos en viaticos a CBA", 12354, "No Procesada", new Supervisor(3, "Dario", "5678", "De Filippis",
